...
ActiveRecord::Schema.define(version: 20160216102230) do
  ...
  create_table "runs", force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci" do |t|
    t.integer  "world_id"
    t.string   "owner"
  ...
  create_table "suites", force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci" do |t|
    t.string   "project"
    t.string   "name"
    t.string   "runner"
  ...
  create_table "test_definitions", force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci" do |t|
    t.string   "name"
    t.string   "node_type"
  ...
  create_table "worlds", force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci" do |t|
    t.string   "type"
    t.string   "name"
    t.text     "description", limit: 65535
    t.string   "project"
